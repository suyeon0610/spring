...
public class BoardController {
	...
	*/
	...
	//{} 안에 변수명을 지어주시고, @PathVariable 괄호 안에 영역을 지목해서 값을 
	//받아옵니다.
	...
	//게시글 수정 처리 요청.
	@PostMapping("/modify")
	public String modify(BoardVO article, PageVO paging) {
		System.out.println("/board/modify: POST");
		service.update(article);
		
		return "redirect:/board/content/" + article.getBoardNo() + "?page=" + paging.getPage() + "&countPerPage=" + paging.getCountPerPage() ;
	}
